...
int gr_shiftExpression(int* tempResult){
	...
	ltype = gr_simpleExpression(tempResult);
	...
	while(isLeftOrRightShift()){
        ...
        getSymbol();
		rtype = gr_simpleExpression(tempResult);

        print(itoa(localFlag,string_buffer,10,0,0));
        print(itoa(flag,string_buffer,10,0,0));
        ...
        print(itoa(localResult,string_buffer,10,0,0));
        print((int*)" ");
        print(itoa(value,string_buffer,10,0,0));
        println();
